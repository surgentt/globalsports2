...
public class _gsups_Styles
{
    [Embed(_resolvedSource='/opt/flex_sdk_4.1/frameworks/libs/framework.swc$Assets.swf', symbol='mx.skins.cursor.BusyCursor', source='/opt/flex_sdk_4.1/frameworks/libs/framework.swc$Assets.swf', original='Assets.swf', _line='534', _file='/opt/flex_sdk_4.1/frameworks/libs/framework.swc$defaults.css')]
    private static var _embed_css_Assets_swf_mx_skins_cursor_BusyCursor_1386056424:Class;
    public static function init(fbs:IFlexModuleFactory):void
    {
        ...
        if (style.defaultFactory == null)
        {
            style.defaultFactory = function():void
            {
                ...
                this.busyCursorBackground = _embed_css_Assets_swf_mx_skins_cursor_BusyCursor_1386056424;
            };
        }
