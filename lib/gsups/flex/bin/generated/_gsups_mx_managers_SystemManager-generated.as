...
public class _gsups_mx_managers_SystemManager
    ...
    implements IFlexModuleFactory, ISWFContext
{
    ...
    public function _gsups_mx_managers_SystemManager()
    {
    ...
    override     public function create(... params):Object
    {
        ...
        var mainClassName:String = params.length == 0 ? "gsups" : String(params[0]);
...
,
            ...
            minHeight: "100",
            minWidth: "600",
            mixins: [ "_gsups_FlexInit", "_gsups_Styles" ],
